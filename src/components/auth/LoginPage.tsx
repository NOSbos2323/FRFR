    ...
    >
      ...
      <div className="absolute top-4 left-4 z-20">
        <motion.button
          ...
          className="flex items-center gap-3 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border border-green-400/30 backdrop-blur-xl group"
        ...
        >
          ...
          <div className="relative">
            ...
            <img
              ...
              alt="Amino Gym"
              className="relative w-5 h-5 rounded-full object-cover border border-white/30"
            />
          </div>
          <Download className="w-4 h-4" />
          <span className="text-sm font-medium">
            {canInstall ? "تثبيت التطبيق" : "إضافة للشاشة"}
          </span>
        </motion.button>
      </div>
      ...
      <div className="absolute top-4 right-4 z-20 flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2 bg-slate-800/60 backdrop-blur-xl rounded-full px-3 py-2 border border-slate-700/50">
          {isOnline ? (
        ...
        <div className="flex items-center gap-2 bg-slate-800/60 backdrop-blur-xl rounded-full px-3 py-2 border border-slate-700/50">
          ...
          <span className="text-xs text-slate-300 font-medium">
            <span className="block sm:hidden">موبايل</span>
            <span className="hidden sm:block md:hidden">تابلت</span>
            <span className="hidden md:block">كمبيوتر</span>
          </span>
        </div>
      </div>
      {/* Content */}
